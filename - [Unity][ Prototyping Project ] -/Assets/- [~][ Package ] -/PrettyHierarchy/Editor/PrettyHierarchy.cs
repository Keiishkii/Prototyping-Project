...
namespace PrettyHierarchy
{
    ...
    public static class PrettyHierarchy
    {
        ...
        {
            UnityEngine.Object instance = UnityEditor.EditorUtility.InstanceIDToObject(instanceID);
        ...
        {
            Texture icon = EditorGUIUtility.ObjectContent(UnityEditor.EditorUtility.InstanceIDToObject(item.InstanceID), null).image;
